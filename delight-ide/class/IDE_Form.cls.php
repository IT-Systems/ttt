...
class IDE_Form extends ArrayIterator
{
    ...
    private function _sanitize() 
    {
        ...
        {
            if($this->_formValidationArray[$sFieldName]['sanitize'] == 1)
            {
    ...
    private function _validate()
    {
        ...
        if(!array_key_exists($sFieldName, $this->_formValidationArray))
        {
            ...
            if($this->_formValidationArray[$sFieldName]['validate'] == 0)
            {
                return false;
            }
            elseif($this->_formValidationArray[$sFieldName]['validate'] == 1)
            {
                $validationType = $this->_formValidationArray[$sFieldName]['validation_type'];
                $validationError = $this->_formValidationArray[$sFieldName]['error_message'];
            }
        }
        $error = '';
