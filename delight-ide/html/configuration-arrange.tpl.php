...
<form id="frmArrConfig" method="post" action="<?php print $_SERVER['PHP_SELF'].'?ID=54';?>" >
<div class="formSpacing">
<table class="tableData" cellspacing="0" cellpadding="0" border="0">
<?php 
foreach($aSortedConfigList as $aRow) { 
?>
<tr style="border-bottom:1px solid #C2E2AC;"> 
<td style="float:left;width:25%;">
  <label><?php print stripslashes($aRow[configname]); ?></label>
  <input type="hidden" name="names[]" value="<?php print stripslashes($aRow[configid]); ?>">	
</td>
