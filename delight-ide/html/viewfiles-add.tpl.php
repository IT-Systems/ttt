...
<form name="frmViewFileAdd" id="frmViewFileAdd" action="<?php print $_SERVER['PHP_SELF'].'?ID=41&VFT='.$_GET['VFT'];?>" method="post">
...
<input type="text" name="txtFileName" id="txtFileName" value="" class="textboxNormal required space" style="width:250px;"/>
</div>
<div class="divSpacing">
<input type="hidden" name="hidAddStatus" id="hidAddStatus" value="1" />
<a href="javascript:void(0);" onclick="javascript:addViewFile();" title="Submit" style="float:left;margin:8px 0px 4px 0px;font-weight:bold;" class="ui-od-button-with-icon ui-state-default ui-corner-all"><span class="ui-icon ui-icon-arrowthick-1-e"></span>Submit</a>
</div>
</form>
</div>
