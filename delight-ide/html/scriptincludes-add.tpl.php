...
<form name="frmAppClassAdd" id="frmAppClassAdd" action="<?php print $_SERVER['PHP_SELF'].'?ID=36';?>" method="post">
<div class="divSpacing">
<label>Script Include Name <span>(File name must have .inc.php appended. Cannot be edited later.)</span></label>
<input type="text" name="txtSIName" id="txtSIName" value="<?php if (isset($_POST[txtSIName])) print $_POST[txtSIName];?>" class="textboxNormal required space" style="width:250px;font-size:11px;"/>
</div>
<div class="divSpacing">
