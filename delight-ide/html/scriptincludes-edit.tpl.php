...
<a href="<?php print $APP->BASEURL;?>/delight-ide/index.php?ID=35" title="Back"><span class="ui-icon ui-icon-circle-arrow-n ui-icon-back" style="margin-top:2px;"></span></a></div>
...
<form name="frmAppClassEdit" id="frmAppClassEdit" action="<?php print $_SERVER['PHP_SELF'].'?ID=37';?>" method="post">
<div class="divSpacing">
<label>Script Include Name <span>(Cannot be edited.)</span></label>
<input type="text" name="txtSIName" id="txtSIName" value="<?php if($_POST['txtSIName']){ print $_POST['txtSIName']; }else{ print stripslashes($sFile); } ?>" class="textboxNormal required" style="width:250px;" readonly="readonly" />
</div>
<div class="divSpacing">
<label>Script Include File Code <span>(Entire content is editable)</span></label>
