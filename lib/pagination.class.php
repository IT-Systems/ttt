        ...
        if (($this->pages) > 1) {
            ...
            if ($this->page != 1) {
                if ($this->showFirstAndLast) {
                    $plinks[] = ' <a href="?page=1'.$queryURL.'">&laquo;&laquo; Ensimmäinen </a> ';
                }
                $plinks[] = ' <a href="?page='.($this->page - 1).$queryURL.'">&laquo; Edellinen</a> ';
            }
            ...
            if ($this->page < $this->pages) {
                $slinks[] = ' <a href="?page='.($this->page + 1).$queryURL.'"> Seuraava &raquo; </a> ';
                if ($this->showFirstAndLast) {
                    $slinks[] = ' <a href="?page='.($this->pages).$queryURL.'"> Viimeinen &raquo;&raquo; </a> ';
                }
            }
