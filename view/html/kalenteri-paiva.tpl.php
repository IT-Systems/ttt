			...
			foreach ($ajat as $aika)
			{
				...
				?>
					<tr>
						<td>
						<?php 														
							echo $aika2['tunti'] . ":" . $aika2['minuutit'];
						?>
						</td>
						<td style="width:830px;">
							<a id="merkinta<?php echo $aika2['merkinta_id']; ?>" href="#merkinta_<?php echo $aika2['merkinta_id']; ?>"><?php echo $aika2['merkinta'];  ?></a>
							<div style="display:none">
								<div id="merkinta_<?php echo $aika2['merkinta_id']; ?>">
									<?php 
										echo $viikonpaiva . " " . $paiva_print . "<p><b>" . $aika2['merkinta'] . "</b><p>" . 
											 $aika2['teksti'];
									?>
								</div>
							</div>
							<script>
								$(document).ready(function() {
									...
									$("#merkinta<?php echo $aika2['merkinta_id']; ?>").fancybox({
