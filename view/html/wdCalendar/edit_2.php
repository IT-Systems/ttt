...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>    
    ...
    <link href="<?php print $APP->BASEURL;?>/view/html/wdCalendar/css/dp.css" rel="stylesheet" />    
    <link href="<?php print $APP->BASEURL;?>/view/html/wdCalendar/css/dropdown.css" rel="stylesheet" />    
    ...
    <script src="<?php print $APP->BASEURL;?>/view/html/wdCalendar/src/Plugins/jquery.form.js" type="text/javascript"></script>     
    <script src="<?php print $APP->BASEURL;?>/view/html/wdCalendar/src/Plugins/jquery.validate.js" type="text/javascript"></script>     
    ...
    <script src="<?php print $APP->BASEURL;?>/view/html/wdCalendar/src/Plugins/jquery.dropdown.js" type="text/javascript"></script>     
