                ...
                $.ajax({
                    ...
                    success: function(data) {//function(datastr) {									
                        ...
                        if (option.onAfterRequestData && $.isFunction(option.onAfterRequestData)) {
                            option.onAfterRequestData(1,data);
                        }
        ...
        function quickd(type) {
            ...
            $.post(option.quickDeleteUrl, param, function(data) {
                if (data) {
                    if (data.IsSuccess) {
                        de = null;
                        option.onAfterRequestData && option.onAfterRequestData(3, data);
                    }
                    else {
                    ...
                    $.post(option.quickUpdateUrl, param, function(data) {
                        if (data) {
                            if (data.IsSuccess == true) {
                                option.isloading = false;
                                option.onAfterRequestData && option.onAfterRequestData(4,data);
                            }
                            else {
                        ...
                        $.post(option.quickAddUrl, param, function(data) {
                            if (data) {
                                if (data.IsSuccess == true) {
                                    ...
                                    render();
                                    option.onAfterRequestData && option.onAfterRequestData(2,data);
                                }
                                else {
